...
int sizeofFunction()
{
  ...
  std::cout << "Size of wchar_t: " << sizeof(wchar_t) << " byte" << std::endl;
  std::cout << "Size of char16_t: " << sizeof(char16_t) << " byte" << std::endl;
  std::cout << "Size of char32_t: " << sizeof(char32_t) << " byte" << std::endl;
